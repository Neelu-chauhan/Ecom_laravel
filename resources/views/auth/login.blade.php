          ...
          $.ajax({
            ...
            error: function(xhr) {
                  ...
                  if (xhr.status === 422 || xhr.status === 401) {
                    ...
                    console.log(errors);
                    $('#div').empty();
                    $('#div').append('<div class="alert alert-danger">' + errors + '</div>');
                  }
              }
          });
