  ...
  <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
      <div class="app-brand demo">
          <a href="index.html" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bold ms-2">ECOM</span>
          </a>
      ...
      <ul class="menu-inner py-1">
          ...
          <li class="menu-item">
              ...
              <ul class="menu-sub">
                  <li class="menu-item">
                      <a href="{{route('category-type.index')}}" class="menu-link">
                          <div class="text-truncate" data-i18n="Without menu">Category Type</div>
                      </a>
                  </li>
                  <li class="menu-item">
          ...
          <li class="menu-item">
              <a href="https://demos.themeselection.com/sneat-bootstrap-html-admin-template/html/vertical-menu-template/app-kanban.html"
                  ...
                  <div class="text-truncate" data-i18n="Kanban">Shopping</div>
              </a>
          </li>
